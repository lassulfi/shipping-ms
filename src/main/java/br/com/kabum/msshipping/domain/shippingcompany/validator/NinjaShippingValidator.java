...
public class NinjaShippingValidator extends Validator {
    ...
    public NinjaShippingValidator(final ValidationHandler aHandler, final ShippingCompany aShippingCompany) {
        super(aHandler);
